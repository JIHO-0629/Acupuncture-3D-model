...
export const GB_POINTS:GbPointDefinition[]=[
 ...
 {code:'GB7',korean:'곡빈',hanja:'曲鬢',english:'Qubin',location:'이개첨 수평선과 측두 두발경계선의 교차 구역',basis:'외이 최상단과 가상 측두 두발경계선',seed:[-.081,1.615,-.012],projection:'head',status:'registered'},
 ...
 {code:'GB14',korean:'양백',hanja:'陽白',english:'Yangbai',location:'정면 동공중선에서 눈썹 위쪽 구역',basis:'안구 정면 투영 중심과 기존 눈썹 메시',seed:[-.034,1.638,.085],projection:'head',status:'registered'},
 {code:'GB15',korean:'두임읍',hanja:'頭臨泣',english:'Toulinqi',location:'동공중선, 전발제 안쪽 0.5촌(골도분촌)',basis:'안구 정면 투영 중심과 가상 전발제선',seed:[-.035,1.670,.071],projection:'head',status:'registered'},
 {code:'GB16',korean:'목창',hanja:'目窓',english:'Muchuang',location:'동공중선, 전발제 안쪽 1.5촌(골도분촌)',basis:'두피 표면의 동공중선',seed:[-.037,1.692,.043],projection:'head',status:'registered'},
 {code:'GB17',korean:'정영',hanja:'正營',english:'Zhengying',location:'동공중선, 전발제 안쪽 2.5촌(골도분촌)',basis:'두피 표면의 동공중선',seed:[-.038,1.706,.012],projection:'head',status:'registered'},
 {code:'GB18',korean:'승영',hanja:'承靈',english:'Chengling',location:'동공중선, 전발제 안쪽 4촌(골도분촌)',basis:'두피 표면의 동공중선',seed:[-.037,1.704,-.027],projection:'head',status:'registered'},
 ...
 {code:'GB30',korean:'환도',hanja:'環跳',english:'Huantiao',location:'대전자–천골열공 곡선의 가쪽 1/3 구역',basis:'대퇴골 대전자와 천골',seed:[-.135,.840,-.085],projection:'posterior',status:'registered'},
 ...
 {code:'GB32',korean:'중독',hanja:'中瀆',english:'Zhongdu',location:'장경인대 뒤쪽, 오금주름 위 7/19 구역',basis:'장경인대와 후면 40% 오금주름',seed:[-.165,.555,-.030],projection:'lateral',status:'registered'},
 ...
 {code:'GB35',korean:'양교',hanja:'陽交',english:'Yangjiao',location:'비골 뒤쪽, 외과 위 7/16 구역',basis:'비골과 가쪽복사 사이의 후외측 피부 경로',seed:[-.145,.250,-.045],projection:'lateral',status:'registered'},
 {code:'GB36',korean:'외구',hanja:'外丘',english:'Waiqiu',location:'비골 앞쪽, 외과 위 7/16 구역',basis:'비골과 가쪽복사 사이의 전외측 피부 경로',seed:[-.145,.250,-.005],projection:'lateral',status:'registered'},
 {code:'GB37',korean:'광명',hanja:'光明',english:'Guangming',location:'비골 앞쪽, 외과 위 5/16 구역',basis:'GB34–외과 앞쪽 피부 곡선',seed:[-.140,.180,.000],projection:'lateral',status:'registered'},
 {code:'GB38',korean:'양보',hanja:'陽輔',english:'Yangfu',location:'비골 앞쪽, 외과 위 4/16 구역',basis:'GB34–외과 앞쪽 피부 곡선',seed:[-.140,.145,.000],projection:'lateral',status:'registered'},
 {code:'GB39',korean:'현종',hanja:'懸鍾',english:'Xuanzhong',location:'비골 앞쪽, 외과 위 3/16 구역',basis:'GB34–외과 앞쪽 피부 곡선',seed:[-.140,.110,.000],projection:'lateral',status:'registered'},
 ...
 {code:'GB43',korean:'협계',hanja:'俠谿',english:'Xiaxi',location:'넷째·다섯째 발가락이 처음 만나는 발샅 가장자리 구역',basis:'제4·5발가락 피부 web margin',seed:[-.160,.018,.090],projection:'dorsal-foot',status:'registered'},
