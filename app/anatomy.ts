...
const KOREAN_ANATOMY_TERMS:Record<string,string>={
 ...
 'diaphragm':'횡격막','external oblique':'외복사근','internal oblique':'내복사근','transversus abdominis':'복횡근','rectus abdominis':'복직근','quadratus lumborum':'요방형근','multifidus':'다열근','inguinal ligament':'서혜인대','pyramidalis':'추체근',
